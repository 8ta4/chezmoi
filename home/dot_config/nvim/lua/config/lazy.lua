...
if vim.g.vscode then
	-- https://github.com/nvim-telescope/telescope.nvim/blob/b4da76be54691e854d3e0e02c36b0245f945c2c7/README.md?plain=1#L161-L162
	vim.keymap.set("n", "<leader>ff", function()
		require("vscode").call("television.ToggleFileFinder")
	end, { desc = "Television find files" })
	vim.keymap.set("n", "<leader>fg", function()
		require("vscode").call("television.ToggleTextFinder")
	end, { desc = "Television live grep" })
end
